      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/editorial-standards" className="block text-sm text-[#6B7280] hover:text-[#D4AF37] transition-colors" data-testid="footer-editorial-standards-link">Editorial Standards</Link>
              <Link to="/privacy-policy" className="block text-sm text-[#6B7280] hover:text-[#D4AF37] transition-colors">Privacy Policy</Link>
              <Link to="/terms-and-conditions" className="block text-sm text-[#6B7280] hover:text-[#D4AF37] transition-colors">Terms & Conditions</Link>
              <Link to="/financial-disclaimer" className="block text-sm text-[#6B7280] hover:text-[#D4AF37] transition-colors">Financial Disclaimer</Link>
            </div>
          </div>
        </div>
